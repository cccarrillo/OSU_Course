; 11ReadFromCSV was written by Charles Ehlschlaeger 9/9/2012.
; It demonstrates reading information from a file and passing it into a turtle.

extensions [ 
  gis        ;; the gis extension allows GIS data to be imported into NetLogo
]
...
to SetupTurtlesFromFile
  ...
  ;;  ...
  file-close-all
  file-open "inputData/11turtleCSVfile.csv"
...
to Go
  output-type "New Timestep " output-print globalVariableTimeStep
...
Model demonstrates reading information from a file and passing it into a turtle.
@#$#@#$#@
default
true
0
