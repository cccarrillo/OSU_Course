; 12CalcArrays was written by Charles Ehlschlaeger 9/9/2012.
; It demonstrates making a calculation from arrays passed to a method. 
; Most of the "previous" code is from 11ReadFromCSV.nlogo
...
to Go
  output-type "Timestep " output-print daySimulation
  ask turtles [
...
to-report CalculateAXplusConstant [ aArray xArray constant ] 
  let result constant
...
Model demonstrates making a calculation from arrays passed to a method. 
